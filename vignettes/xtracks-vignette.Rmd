...
## Load some spatiotemporal data

First you need to load some spatiotemporal data into a dataframe. For demonstration purposes, the xtracks package comes with two dataframes named <code>d1</code> and <code>d2</code> that are appropriately formatted. The structure of the data can be seen below. 
...
A nice dynamic map of the xtrack can be created using mapview. More visualization options will be highlighted at the end of the vignette.
